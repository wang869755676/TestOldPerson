...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public static final String TAG = "aaCrashHandler";
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                Toast.makeText(mContext, "很抱歉,程序出现异常,即将重启设备！", Toast.LENGTH_LONG).show();
                Looper.loop();
            }
        }.start();
        //收集设备参数信息
...
//                .setTitle(" ")
//                .setMessage("系统错误:无法连接到相机")
//                .setIcon(R.drawable.logo02)
//                .setCancelable(false)
